...
sd.putNumber('goalsensor.x_adj', 1) # suggest a movement to the right
sd.putNumber('goalsensor.z_adj', 1) # suggest a movement to the front
...
sd.putNumber('gearsensor.x_adj', 1) # suggest a movement to the right
sd.putNumber('gearsensor.z_adj', 1) # suggest a movement to the front
...
sd.putNumber('ropesensor.x_adj', 1) # suggest a movement to the right
sd.putNumber('ropesensor.z_adj', 1) # suggest a movement to the front
